...
$inputOrdering      = Form::input('text', 'form[ordering]', 'ordering', $dataForm['ordering'], 'form-control form-control-sm');
...
if (isset($this->arrParam['id'])) {
    ...
    $linkFilePicture    = URL::createLinkPicture('category', $dataForm['picture']);
    $rowShowPicture = Form::formGroup('', '<img width="150px" height="auto" src="'.$linkFilePicture.'">');
}
// Row
$rowName        = Form::formGroup('Name', $inputName, true);
$rowOrdering    = Form::formGroup('Ordering', $inputOrdering, true);
$rowStatus      = Form::formGroup('Status', $selectStatus);
...
<div class="card card-info card-outline">
    <div class="card-body">
        <form enctype="multipart/form-data" action="" method="post" class="mb-0" id="admin-form">
            <?= $rowID . $rowName . $rowOrdering . $rowStatus . $rowFilePicture . $rowShowPicture?>
