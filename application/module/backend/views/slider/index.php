...
foreach ($this->items as $item) {
    ...
    $linkFilePicture    = URL::createLinkPicture('slider', $item['picture']);
    ...
    $description        = HTML::highLight($item['description'], $searchValue);
    $link               = HTML::highLight($item['link'], $searchValue);
